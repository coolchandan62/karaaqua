                        ...
                        <div class="row" id="options-container">
                            ...
                            <div class="col-md-12 mb-2">
                              ...
                              <div class="col-md-12 mb-2">
                                <div class="form-group">
                                    <label> Feature </label>
                                    <textarea type="text" name="feature" id="editor2"
                                        class='form-control'> <?= $product['feature'];?></textarea>
                                    <div class='clearfix'></div>
                                    <span class='message' id="msgfeature"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="additional_information" id="editor1"
                                        class='form-control'><?= $product['additional_information'];?></textarea>
                                    <div class='clearfix'></div>
                                    <span class='message' id="msgadditional_information"></span>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="header_script" style="height:300px;" class='form-control'><?php echo $product['header_script']; ?></textarea>
                                    <div class='clearfix'></div>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="body_script" style="height:300px;" class='form-control'><?php echo $product['body_script']; ?></textarea>
                                    <div class='clearfix'></div>
...
<script src="<?= base_url("assets/admin/page/product.js?v=0.1") ?>"></script>
