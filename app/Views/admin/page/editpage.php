                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="header_script" style="height:300px;" class='form-control'><?php echo $page['header_script']; ?></textarea>
                                    <div class='clearfix'></div>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="body_script" style="height:300px;" class='form-control'><?php echo $page['body_script']; ?></textarea>
                                    <div class='clearfix'></div>
...
<script src="<?= base_url("assets/admin/page/page.js?v=0.2") ?>"></script>