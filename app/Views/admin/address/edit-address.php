            ...
            <fieldset>
                ...
                <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    <label>Address</label>
                                    <textarea type="text" name="address" id="address" class='form-control' style="height:70px"><?= $addressData['address'];?></textarea>
                                    <div class='clearfix'></div>
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="form-group">
                                    <label>Phone</label>
                                    <input type="text" name="phone" class='form-control' value="<?= $addressData['phone'];?>">
                                    <div class='clearfix'></div>
