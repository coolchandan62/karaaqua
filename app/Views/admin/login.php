          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-center p-5">
                ...
                <form class="pt-3" id="login-frm">
                  
                  <input type="hidden" name="service_role_type" value='1'>
                  ...
                  <div class="mt-3">
                    <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" id="authenticateAdminLogin" type="button">SIGN IN</button>
                  </div>
