  ...
  <section class="main-slider-two clearfix" style="background:#102b6e">
    ...
    <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="image-layer-two"> <img src="<?php echo base_url();?>assets/ro-service/images/backgrounds/banner-1.webp"> </div>
        </div>
        <!-- <div class="swiper-slide">
    ...
    <div class="event-header">
      ...
      <form id="send" class="send-form">
        <input type="hidden" name="contact_page_name" value="RO Installation Service">
    ...
    <div class="container">
      ...
      <div class="contact-one__form-box">
        <form action="p" class="contact-one__form contact-form-validated"
           ...
           <input type="hidden" name="home_page_name" value="RO Installation Service" >
          <div class="row">
...
<div id="popup-reg" class="popup">
  <div class="popup-content">
    <div class="event-header">
      ...
      <form id="send" class="send-form">
            <input type="hidden" name="popup_page_name" value="RO Installation Service">
        <div class="form-group">
