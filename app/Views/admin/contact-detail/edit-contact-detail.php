                ...
                <fieldset>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="form-group">
                                    <label>Phone3</label>
                                    <input type="text" name="phone3" id="phone3" class='form-control' value="<?= $contactData['phone3'];?>">
                                    <div class='clearfix'></div>
                                    <span class='message' id="msgphone3"></span>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="linkedin_url" id="linkedin_url" class='form-control'><?= $contactData['linkedin_url'];?></textarea>
                                    <div class='clearfix'></div>
                                    <span class='message' id="msglinkedin_url"></span>
                                </div>
                            </div>
                        </div>
                    </fieldset>
...
<script src="<?= base_url("assets/admin/page/contact-detail.js?v=0.1") ?>"></script>