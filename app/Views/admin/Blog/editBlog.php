                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="header_script" style="height:300px;" class='form-control'><?php echo $blog['header_script']; ?></textarea>
                                    <div class='clearfix'></div>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="body_script" style="height:300px;" class='form-control'><?php echo $blog['body_script']; ?></textarea>
                                    <div class='clearfix'></div>
...
<script src="<?= base_url("assets/admin/page/blog.js?v=0.3") ?>"></script>