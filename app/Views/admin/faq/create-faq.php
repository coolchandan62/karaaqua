        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-sample">
                    ...
                    <button type="button" id="authenticateFaq" class="btn btn-primary mr-2 float-right">Submit</button>
                </form>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td data-label="Action">
                              ...
                              <a href="<?=base_url()?>admin/Faq/deleteFaq/<?php echo $faq['id']."/".$service_id."/".$type;?>" onclick="return confirm('Are you sure. You want to delete this?')" class="ml-auto badge badge-warning p-2" ><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                          </tr>
