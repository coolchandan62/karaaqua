        ...
        <div class="row">
          <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
            <div class="footer-widget__column footer-widget__about">
              <div class="footer-widget__logo"> <a href="<?=base_url()?>"><img src="<?=base_url()?>assets/home/images/kara-logo.png" alt=""></a> </div>
            ...
            <div class="footer-widget__column footer-widget__Contact">
              ...
              <ul class="footer-widget__Contact-list list-unstyled">
                ...
                <li>
                  ...
                  <div class="text">
                    <p> <a href="tel:9220231010">9220231010</a> <a href="tel:9220241010">9220241010</a> </p>
                  </div>
                </li>
                     <li>
                  <div class="icon"> <span class="fas fa-headphones"></span> </div>
                  <div class="text">
                    <p> <a href="tel:18005692666">Toll Free 18005692666</a>  </p>
                  </div>
                </li>
                <li>
                  <div class="icon"> <span class="fas fa-envelope"></span> </div>
                  <div class="text">
                    <p> <a href="mailto:<?=$contactDetail['email1']?>"><?=$contactDetail['email1']?> </a> </p>
                  </div>
                </li>
              </ul>
            </div>
...
<div class="mobile-nav__wrapper">
  ...
  <div class="mobile-nav__content"> <span class="mobile-nav__close mobile-nav__toggler"><i class="fa fa-times"></i></span>
    ...
    <div class="mobile-nav__top">
      <div class="mobile-nav__social"> <a href="<?= $contactDetail['twitter_url'];?>" target="_blank">
