                ...
                <div class="card">
                  ...
                  <div class="d-sm-flex align-items-center mb-4">
                        <h4 class="card-title mb-sm-0">Testimonial List</h4>
                         <a href="<?= base_url();?>admin/testimonial/create-testimonial" class="ml-auto badge badge-warning p-2 float-right">Create
            Testimonial</a>
                      </div>
                      <p>&nbsp;</p>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td data-label="Action">
                              ...
                              <?php }?>
                               <a href="<?= base_url() ?>admin/testimonial/delete-testimonial/<?php echo $testimonial['id']; ?>"
