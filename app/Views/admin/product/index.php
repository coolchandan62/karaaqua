                          ...
                          <tr>
                           ...
                           <th scope="col">Price</th>
                            <th scope="col">Action</th>
                             <th scope="col">Home Page Product</th>
                             <th scope="col">Faq</th>
                          ...
                          <tr>
                            <td data-label="#"><?= $count++;?></td>
                             ...
                             <td data-label="heading"><?php echo $product['heading']?></td>
                              <td data-label="heading"><?php echo $product['price']?></td>
                            ...
                            <td data-label="Action">
                              ...
                              <a href="<?=base_url()?>admin/product/delete/<?php echo $product['id'];?>" class="ml-auto badge badge-warning p-2" onclick="return confirm('Are you sure. You want to delete this?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                               ...
                               <td>
                              <?php if($product['home_page_product']==1){?>
                              <a href="<?php echo base_url("admin/product/updateHomeStatus/".$product['id']."/0");?>" class="badge badge-success p-2" style='background:green;' onclick="return confirm('Are you sure. You want to deactivate this?')"><i class="fa fa-check" aria-hidden="true"></i></a>
                              <?php }else{?>
                              <a href="<?php echo base_url("admin/product/updateHomeStatus/".$product['id']."/1");?>" class="badge badge-danger p-2" onclick="return confirm('Are you sure. You want to activate this?')"><i class="fa fa-times" aria-hidden="true"></i></a>
                              <?php }?>
                              </td>
                              <td>
                              <a href="<?=base_url()?>admin/faq/create-faq/<?php echo $product['id'];?>/3" class="ml-auto badge badge-warning p-2" >Faq</a>
                             </td>
                          </tr>
