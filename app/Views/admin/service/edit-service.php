                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    <label>Heading</label>
                                    <input type="text" name="heading" value="<?= $serviceData["heading"];?>"
                                        class='form-control'>
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="heading_slug" value="<?= $serviceData["heading_slug"];?>"
                                        class='form-control'>
                                    <div class='clearfix'></div>
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    <label>Image <img
                                            src="<?php echo base_url("assets/uploads/service/" . $serviceData['image']); ?>"
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    <label> Thumb Image <img
                                            src="<?php echo base_url("assets/uploads/service/" . $serviceData['thumb_image']); ?>"
                                            style='width:50px;' /></label>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="short_description"
                                        ...
                                        class='form-control'><?php echo $serviceData['short_description']; ?></textarea>
                                    <div class='clearfix'></div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="editor" placeholder="Enter Description"
                                        class='form-control'
                                        style="height:100px;"><?= $serviceData["description"] ?></textarea>
                                    <div class='clearfix'></div>
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-2">
                                <div class="form-group">
                                    <label>Og Image<img
                                            src="<?php echo base_url("assets/uploads/service/" . $serviceData['og_image']); ?>"
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="meta_title" id="meta_title"
                                        class='form-control'><?php echo $serviceData['meta_title']; ?></textarea>
                                    <div class='clearfix'></div>
                            ...
                            <div class="col-md-5 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="meta_description" id="meta_description"
                                        class='form-control'><?php echo $serviceData['meta_description']; ?></textarea>
                                    <div class='clearfix'></div>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="header_script" style="height:300px;" class='form-control'><?php echo $serviceData['header_script']; ?></textarea>
                                    <div class='clearfix'></div>
                                    <span class='message' id="msgheader_script"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="body_script" style="height:300px;" class='form-control'><?php echo $serviceData['body_script']; ?></textarea>
                                    <div class='clearfix'></div>
                                    <span class='message' id="msgbody_script"></span>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        <button type="button" id="authenticateServiceUpdate"
...
<script src="<?= base_url("assets/admin/page/service.js?v=0.4") ?>"></script>